  ...
  return Scaffold(
    appBar: AppBar(
      ...
      leading: IconButton(
        ...
        onPressed: () {
          context.pop(); // 👈 go back
          context.read<QuizViewModels>().getQuizzezByid(int.parse(widget.classroomID),false);
        },
      ),
    ),
    body: Container(
        ...
        children: [
          ...
          Expanded(
            child: (questions == null)
              ? Center(
                  child: Text(
                    'Sorry there is no question yet, please add new question',
